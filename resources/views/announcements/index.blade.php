...
<div class="animate-fade-up">
    ...
    <div class="d-flex justify-between align-center" style="margin-bottom: 2rem; flex-wrap: wrap; gap: 1rem;">
        ...
        <button class="btn btn-primary" onclick="openAnnouncementModal()" style="display: inline-flex; align-items: center; gap: 0.5rem; border-radius: 1.25rem; padding: 0.8rem 1.5rem; font-weight: 800; box-shadow: 0 4px 12px rgba(var(--primary-rgb), 0.25); transition: all 0.2s ease; width: fit-content;">
            <i class="ph ph-plus-circle" style="font-size: 1.2rem;"></i> <span>{{ __('Create Announcement') }}</span>
        </button>
    </div>
